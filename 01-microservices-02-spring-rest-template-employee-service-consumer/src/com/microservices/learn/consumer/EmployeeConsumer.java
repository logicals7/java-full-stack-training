...
public class EmployeeConsumer {
    ...
    private static final String BASE_URL = "http://localhost:8080/employee-service/";
    ...
    private static void addEmployee() {
        ...
        employeeBean.setEmpName("John Doe");
        employeeBean.setSalary(234567.00);
        employeeBean.setDeptCode(101);
    ...
    private static void findEmployeeById() {
        ...
        EmployeeBean employeeBean = restTemplate.getForObject(BASE_URL + "findEmployeeById/2", EmployeeBean.class);
        if (employeeBean != null){
            ...
            System.out.println("deptCode: " + employeeBean.getDeptCode());
        } else{
    ...
    private static void updateEmployee() {
        ...
        EmployeeBean employeeBean = new EmployeeBean();
        employeeBean.setEmpId(3);
        employeeBean.setEmpName("KK");
        employeeBean.setSalary(45098763.00);
        employeeBean.setDeptCode(202);
