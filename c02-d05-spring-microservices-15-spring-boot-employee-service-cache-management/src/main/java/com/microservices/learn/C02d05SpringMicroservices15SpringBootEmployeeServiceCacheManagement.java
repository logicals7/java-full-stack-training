...
@EnableCaching
public class C02d05SpringMicroservices15SpringBootEmployeeServiceCacheManagement {


    public static void main(String[] args) {
        SpringApplication.run(C02d05SpringMicroservices15SpringBootEmployeeServiceCacheManagement.class, args);
    }
